...
from code.util import COLUMN_TWEET, COLUMN_USERNAME, SUFFIX_TOKENIZED, SUFFIX_COUNTED
...
parser.add_argument("-c", "--count", action = "store_true", help = "counts how often each element of the given column is present")
parser.add_argument("--counted_input", help = "input column to count", default = COLUMN_USERNAME)
