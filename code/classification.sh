...
python -m code.classification.run_classifier data/dimensionality_reduction/training.pickle -e data/classification/classifier.pickle --support_vector_machine 2000 -s 42 --accuracy --kappa --recall --f_measure 
